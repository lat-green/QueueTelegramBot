...
@Component
class EnqueueByNumberStateProvider(val positionRepository: PositionRepository, val queueRepository: QueueRepository, val clientRepository: ClientRepository) : StateProvider {
	...
	override fun findOrNull(sender: ChatSender, stateName: String): ChatState? {
		...
		return EnqueueByNumberState(positionRepository, queueRepository, clientRepository, queueId, "main-menu")
	}
}